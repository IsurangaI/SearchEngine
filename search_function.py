...
syn_birthplace_sin=["උපත ලැබූ" , "උපත ලද", "උපන් ස්ථානය", "නගරය", "ගම"]
...
synonym_list = [syn_writer_sin, syn_writer_eng, syn_birthplace_sin, syn_birthplace_eng, syn_language_sin, syn_language_eng, synonym_education]
